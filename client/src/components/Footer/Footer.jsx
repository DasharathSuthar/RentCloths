...
const Footer = () => {
  return (
    <footer className="mt-10 flex flex-col bg-slate-100 border-t border-secondary items-center justify-around w-full py-10 text-sm text-gray-800/70">
      <div className="flex items-center gap-8">
        <Link
          to="/"
          className="font-medium text-gray-700 hover:text-secondary transition-all"
        >
          Home
        </Link>
        <Link
      ...
      <div className="flex items-center gap-4 mt-8 text-secondary">
        <a
          href="#"
      ...
      <p className="mt-8 text-center">
        ...
        <span className="text-primary font-bold"> Rent Cloths</span>. All rights
        reservered.
      </p>
    </footer>
  );
