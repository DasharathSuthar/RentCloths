    ...
    <>
      <div className="flex flex-col items-center text-sm mt-10">
        ...
        <p className="text-sm text-gray-500 text-center pb-10">
          Have questions about our rental process, your orders, or just want to
          say hi?
          <br />
          We’re always here to help you look your best without the hassle.{" "}
          <br />
          Reach out to us anytime — our friendly support team will get back to
