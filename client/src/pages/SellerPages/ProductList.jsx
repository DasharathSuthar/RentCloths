...
const ProductList = () => {
  const { products, currency, axios, fecthProducts } = useAppContext();
  ...
  return (
    <>
      ...
      <div className="no-scrollbar flex-1 capitalize h-[95vh] overflow-y-scroll flex flex-col justify-between">
